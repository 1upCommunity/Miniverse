class Map {
  ...
  preload() {
    ...
    this.textures.road_turn_down_left = loadImage(
      "assets/road_turn_down_left.png"
    );
    this.textures.road_turn_down_right = loadImage(
      "assets/road_turn_down_right.png"
    );
    this.textures.road_turn_left_up = loadImage("assets/road_turn_left_up.png");
    this.textures.road_turn_right_up = loadImage(
      "assets/road_turn_right_up.png"
    );
  ...
  generate() {
    ...
    this.chunks._3x0 = new Chunk(
      3,
      0,
      500,
      500,
      this.textures.road_turn_left_up
    );
    this.chunks._3x_1 = new Chunk(3, -1, 500, 500, this.textures.road_up);
    this.chunks._3x_2 = new Chunk(
      3,
      -2,
      500,
      500,
      this.textures.road_3side_left
    );
    ...
    this.chunks.__3x0 = new Chunk(
      -3,
      0,
      500,
      500,
      this.textures.road_turn_right_up
    );
    this.chunks.__3x_1 = new Chunk(-3, -1, 500, 500, this.textures.road_up);
    this.chunks.__3x_2 = new Chunk(
      -3,
      -2,
      500,
      500,
      this.textures.road_3side_right
    );
    ...
    this.chunks.__3x_9 = new Chunk(
      -3,
      -9,
      500,
      500,
      this.textures.road_turn_down_right
    );
    ...
    this.chunks.__0x_9 = new Chunk(
      0,
      -9,
      500,
      500,
      this.textures.road_turn_down_left
    );
    ...
    // buildings
    this.chunks.__1x_1 = new Chunk(
      -1,
      -1,
      500,
      500,
      this.textures.building_1,
      true
    );
    this.chunks.__2x_1 = new Chunk(
      -2,
      -1,
      500,
      500,
      this.textures.building_2,
      true
    );
    this.chunks._1x_1 = new Chunk(
      1,
      -1,
      500,
      500,
      this.textures.hospital,
      true
    );
  }
  ...
  draw() {
    ...
    for (const i in this.chunks) {
      if (
        dist(
          this.chunks[i].x * this.chunks[i].w,
          this.chunks[i].y * this.chunks[i].h,
          camera.x,
          camera.y
        ) <
        windowHeight * 5
    ...
    // current chunk text
    if (debug) {
      const currentChunk = [round(camera.x / 500), round(camera.y / 500)];
      push();
      fill(255);
      textSize(windowWidth / 50);
      text(
        "current chunk: " + currentChunk[0] + "x" + currentChunk[1],
        windowWidth / 2 -
          textWidth(
            "current chunk: " + currentChunk[0] + "x" + currentChunk[1]
          ) /
