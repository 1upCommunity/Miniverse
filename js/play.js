class PlayScreen {
  ...
  draw() {
    ...
    if (this.substate == "name") {
      ...
      text(
        "And your name is...",
        windowWidth / 2 - textWidth("And your name is...") / 2,
        (windowHeight / 10) * 3 - textWidth("And your name is...") / 2
      );
  ...
  setup() {
    ...
    this.name_input.position(
      windowWidth / 2 - this.name_input.width / 2,
      (windowHeight / 10) * 4
    );
    this.name_button = createButton("Submit");
    this.name_button.position(
      windowWidth / 2 - textWidth("Submit") / 2,
      (windowHeight / 10) * 5 - textWidth("Submit") / 2
    );
