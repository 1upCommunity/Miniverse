class Home extends Screen {
    ...
    draw(){
        ...
        if(!this.animations_loaded){
            ...
            this.textInput.position(windowWidth/2 - windowWidth/8, windowHeight/2)
        ...
        image(this.image, window.innerWidth/2 - this.image.width/2, this.animation_props.y)
        this.play_button.locate(windowWidth/2 - windowWidth/8, this.image.height + 200 + (this.animation_props.y - this.image.height/8*3)/8*6)
        this.play_button.width = windowWidth/4
        this.play_button.draw()
        
        fill(255)
        textSize(18)
        text("And your name is...", windowWidth/2 - windowWidth/8, this.image.height + 100 + (this.animation_props.y - this.image.height/8*3)/8*6)
        this.textInput.position(windowWidth/2 - windowWidth/8, this.image.height + 120 + (this.animation_props.y - this.image.height/8*3)/8*6)
        this.textInput.size(windowWidth/4, 30)
    }
